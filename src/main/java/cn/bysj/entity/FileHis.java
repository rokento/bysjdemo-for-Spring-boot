...
public class FileHis {
	...
	public String toString() {
		return "FileHis [systemid=" + systemid + ", fileid=" + fileid + ", userid=" + userid + ", cn_name=" + cn_name
				+ ", filename=" + filename + ", filepath=" + filepath + ", sort=" + sort + ", tags=" + tags + ", cjsj="
				+ cjsj + "]";
	}
